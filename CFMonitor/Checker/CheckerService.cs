    ...
    public class CheckerService : IChecker
    {
        public void Check(MonitorItem monitorItem, List<IActioner> actionerList)
        {
            ...
            try
            {
                ...
                ServiceController[] serviceControllers = String.IsNullOrEmpty(monitorService.MachineName) ? ServiceController.GetServices() : ServiceController.GetServices(monitorService.MachineName);
