...
namespace CFMonitor
{
    ...
    internal class MonitorItemFactory
    {
        ...
        public static void Create(IMonitorItemRepository monitorItemRepository)
        {
            monitorItemRepository.Insert(CreateTestMonitorURL());
            monitorItemRepository.Insert(CreateSQLServiceMonitor());
            monitorItemRepository.Insert(CreateTestMonitorPing());
            monitorItemRepository.Insert(CreateTestMonitorSQL());
            monitorItemRepository.Insert(CreateTestMonitorFile());
            monitorItemRepository.Insert(CreateTestMonitorProcess());          
        }
        ...
        private static MonitorSQL CreateTestMonitorSQL()
        {
            ...
            eventItem.EventCondition.Source = "OnRows";
        ...
        private static MonitorProcess CreateTestMonitorProcess()
        {
            ...
            eventItem2.EventCondition.Source = "OnProcessNotRunning";
        ...
        private static MonitorFile CreateTestMonitorFile()
        {
            ...
            EventItem eventItem2 = new EventItem();
            eventItem2.EventCondition.Source = "OnFileNotExists";
        ...
        private static MonitorPing CreateTestMonitorPing()
        {
            ...
            // Add event for Status not success
            EventItem eventItem = new EventItem();
            eventItem.EventCondition.Source = "Reply.Status";
            eventItem.EventCondition.Operator = ConditionOperators.NotEquals;
            eventItem.EventCondition.Values.Add(System.Net.NetworkInformation.IPStatus.Success);
        ...
        private static MonitorURL CreateTestMonitorURL()
        {
            ...
            EventItem eventItem = new EventItem();
            eventItem.EventCondition.Source = "Response.StatusCode";
            eventItem.EventCondition.Operator = ConditionOperators.NotEquals;
        ...
        private static MonitorService CreateSQLServiceMonitor()
        {
            ...
            // Add event for StatusCode not OK, send email
            EventItem eventItem = new EventItem();
            eventItem.EventCondition.Source = "ServiceController.Status";
            eventItem.EventCondition.Operator = ConditionOperators.NotEquals;
